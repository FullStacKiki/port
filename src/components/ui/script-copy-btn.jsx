        ...
        <div className="mb-2 flex items-center justify-between">
          {showMultiplePackageOptions && (
            <div className="relative">
              <div
                className="inline-flex overflow-hidden rounded-md border border-zinc-200 text-xs dark:border-zinc-800">
        ...
        <div className="relative flex items-center">
          <div className="min-w-[300px] grow font-mono">
            {highlightedCode ? (
              ...
              <pre
                className="rounded-md border border-zinc-200 bg-white p-2 px-4 font-mono dark:bg-black dark:border-zinc-800">
                {command}
              </pre>
            )}
          </div>
